...
a tidy data set as required by the Course Project assignement. The output data set is written
...
You may want to look throgh the script code with embedded comments for further datails. 
